...
always_comb begin
    ...
    {1'b?, 7'b0?00000, F3_SRL_SRA, OP_IMM}:      cw <= '{ 1'b0, ALU_OP1_RS1,  ALU_OP2_IMMI, alu_mode7, WB_SRC_ALU, WB_DST_REG, WB_MODE_X,    PC_NEXT,     1'b0 };
    {1'b?, 7'b???????, 3'b???,     OP_IMM}:      cw <= '{ 1'b0, ALU_OP1_RS1,  ALU_OP2_IMMI, alu_mode3, WB_SRC_ALU, WB_DST_REG, WB_MODE_X,    PC_NEXT,     1'b0 };
    {1'b?, 7'b???????, 3'b???,     OP_LUI}:      cw <= '{ 1'b0, ALU_OP1_IMMU, ALU_OP2_RS2,  ALU_COPY1, WB_SRC_ALU, WB_DST_REG, WB_MODE_X,    PC_NEXT,     1'b0 };
    {1'b?, 7'b???????, 3'b???,     OP_AUIPC}:    cw <= '{ 1'b0, ALU_OP1_IMMU, ALU_OP2_PC,   ALU_ADD,   WB_SRC_ALU, WB_DST_REG, WB_MODE_X,    PC_NEXT,     1'b0 };
    {1'b?, 7'b???????, 3'b???,     OP}:          cw <= '{ 1'b0, ALU_OP1_RS1,  ALU_OP2_RS2,  alu_mode7, WB_SRC_ALU, WB_DST_REG, WB_MODE_X,    PC_NEXT,     1'b0 };
    {1'b?, 7'b???????, 3'b???,     OP_JAL}:      cw <= '{ 1'b0, ALU_OP1_X,    ALU_OP2_X,    ALU_X,     WB_SRC_PC4, WB_DST_REG, WB_MODE_X,    PC_JUMP_REL, 1'b0 };
    {1'b?, 7'b???????, 3'b???,     OP_JALR}:     cw <= '{ 1'b0, ALU_OP1_X,    ALU_OP2_X,    ALU_X,     WB_SRC_PC4, WB_DST_REG, WB_MODE_X,    PC_JUMP_ABS, 1'b0 };
    ...
    {1'b?, 7'b???????, 3'b???,     OP_LOAD}:     cw <= '{ 1'b0, ALU_OP1_RS1,  ALU_OP2_IMMI, ALU_ADD,   WB_SRC_MEM, WB_DST_REG, WB_MODE_X,    PC_NEXT,     1'b0 };
